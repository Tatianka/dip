...
\\ \\ 
{\bf Kľúčové slová:} regex, spätné referencie, pozitívny a negatívny lookaround, lookahead, lookbehind, priestorová zložitosť
%\end{center}
\end{minipage}
\end{center}
\eject % EOP v
...
\\ \\
{\bf Key words:} regex, backreference, positiv and negativ lookaround, lookahead, lookbehind, space complexity
%\end{center}
\end{minipage}
\end{center}
\eject % EOP v
