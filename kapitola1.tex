...
Téme moderných regulárnych výrazov sme sa venovali už v bakalárskej práci \cite{mojaBak}, v tejto práci naviažeme na tieto výsledky. Keď sme hľadali články k tejto téme, našli sme výsledky iba o regulárnych výrazoch schopných generovať iba regulárne jazyky a preštudovaná bola aj trieda $\e$.

V prvom rade nás zaujímali operácie lookaroundu -- pozitívna aj negatívna forma.

\begin{veta}[{\cite[Veta 2.2.5.]{mojaBak}}]\label{lookahead+R}
Regulárne jazyky sú uzavreté na pozitívny lookaround.
\end{veta}

\begin{veta}[{\cite[Veta 2.2.10.]{mojaBak}}]\label{lookaround+R}
Trieda $\re$ s pozitívnym lookaroundom je $\R$.
\end{veta} 

\begin{veta}[{\cite[Veta 2.2.14.]{mojaBak}}]\label{le+lcs}
$ \lel \subseteq \L_{CS} $
\end{veta}
