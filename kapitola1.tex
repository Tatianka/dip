...
Téme moderných regulárnych výrazov sme sa venovali už v bakalárskej práci \cite{mojaBak}, v tejto práci naviažeme na tieto výsledky. Keď sme hľadali články k tejto téme, našli sme výsledky len o regulárnych výrazoch schopných generovať iba regulárne jazyky a preštudovaná bola trieda $\e$. Popíšme si teraz poznatky nadobudnuté v oblasti nášho záujmu.

V prvom rade nás zaujímal samotný lookaround -- v pozitívnej aj negatívnej forme.
...
\begin{veta}\textbf{\emph{\cite[Veta 2.2.14.]{mojaBak}}}\label{le+lcs} \ \par
$ \lel \subseteq \L_{CS} $
\end{veta}
