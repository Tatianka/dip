...
Otvoreným problémom zostáva, či je trieda $\lel$ uzavretá aj na Kleeneho $*$. Konštrukcia z dôkazu o zreťazení fungovať nebude, pretože $*$ môže urobiť ľubovoľný počet iterácií, zápis regexu musí byť konečnej dĺžky a lookahead a lookbehind by bolo nutné usmerňovať v každej iterácii zvlášť. Naša hypotéza je, že uzavretosť neplatí, avšak doposiaľ sa nám nepodarilo nájsť vhodný jazyk na dôkaz.
...
\end{equation*}
Dôsledkom nerovnosti by potom bolo, že trieda $\lel$ nie je uzavretá na komplement, lebo túto vlastnosť zaručuje práve negatívny lookaround.
...
A to je ten istý odhad ako v dôkaze vety \ref{dspace_nlog2n}.
\end{proof}
...
Nech $C_1=(d_1,\dots,d_m)$, $C_2=(e_1,\dots,e_m)$, pričom musí platiť $(d_2,\dots,d_m)=(e_2,\dots,\allowbreak e_m)$. 
...
Počet jeho znakov je $m+(m-1)(3+m) = m^2+3m-3$. Zápis s pozitívnym lookaheadom je efektívnejší od $m\geq 7$.
