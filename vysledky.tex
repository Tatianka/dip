...
\end{lema}
\begin{proof}
Nech $L_1,L_2,L_3 \in \R$, existujú DKA $ A_{i} = (K_{i},\Sigma_{i},\delta_{i},q_{0i},F_{i}) $ také, že $ L(A_{i})=~L_{i},\allowbreak i \in \lbrace 1,2,3\rbrace $. Ukážeme, že $L=L_1\nlookbehind L_2)L_3 \in \R$.
